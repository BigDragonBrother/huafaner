...
/**
 * 序列号,请通过亿美销售人员获取
 *账号；0SDK-EMY-0130-NBQQS 密码；197848
 */
$serialNumber = '0SDK-EMY-0130-NBQQS';
...
//----------------------------------------------------------------------
	...
	$statusCode = $client->sendSMS(array('18618148163'),"huafaner测试，by 沈国龙");
...
function sendSMS()
{
	 ...
	 */
	$statusCode = $client->sendSMS(array('18600092829'),"huafaner测试，by 沈国龙");
	echo "处理状态码:".$statusCode;
}
